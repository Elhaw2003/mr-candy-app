...
import 'package:mr_candy_app/featuers/home/presentation/view/main_home/widgets/bannar_and_smooth_widget.dart';
                    ...
                    SliverGrid.builder(
                      ...
                      itemBuilder: (context, index) {
                        return BlocBuilder<MostSellingCubit, MostSellingStates>(
                          builder: (context, state) {
                            return state is LoadingMostSellingState?const Center(child: CircularProgressIndicator()) : MostSellingGridView(
                              mostSellingModel:
                                  BlocProvider.of<MostSellingCubit>(context)
                                      .products[index],
                            );
                          },
                        );
